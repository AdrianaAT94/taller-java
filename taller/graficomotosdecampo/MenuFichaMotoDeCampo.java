...
public class MenuFichaMotoDeCampo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuFichaMotoDeCampo(){
        ...
        setResizable(false); //Que non se poda ccamiar o tamaanho da ventana
        ...
        fic = new Ficha();
        cam = new Campo();
        sfechaEntrada = cam.getfechaAlta(cam.getUltimoRegitro());
        scliente = cam.getNombrecliente(cam.getUltimoRegitro());
        svehiculo = cam.getNombrevehiculo(cam.getUltimoRegitro());
...
idvehi = cam.getUltimoRegitro();
		
		if (cam.getCombustible(idvehi).equals("diésel")){
			inputdescripcion.setText("Revisión del filtro de partículas");
			if (cam.getNombretipovehiculo(idvehi).equals("camulancia") || cam.getNombretipovehiculo(idvehi).equals("Bomberos") || cam.getNombretipovehiculo(idvehi).equals("Policía")) {
				inputdescripcion.setText("Revisión del filtro de partículas, Revisión de la sirena");	
			}
		}
		else if (cam.getnRuedas(idvehi).equals("2")) {
		...
		else if (cam.getNombretipovehiculo(idvehi).equals("camulancia") || cam.getNombretipovehiculo(idvehi).equals("Bomberos") || cam.getNombretipovehiculo(idvehi).equals("Policía")) {
	...
	public void actionPerformed(ActionEvent e) {		
		...
		if (e.getActionCommand().equals("ENVIAR")) {
				...
				if (fic.editar(cam.getUltimoRegitro(), inputdescripcion.getText(), sest, inputfechaSalida.getText(), inputmotivo.getText())) {
