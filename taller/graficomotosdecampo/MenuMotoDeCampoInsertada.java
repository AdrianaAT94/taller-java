...
public class MenuMotoDeCampoInsertada extends JFrame implements KeyListener, ActionListener{
	...
	public MenuMotoDeCampoInsertada() {
		super("Taller"); //Nome
        ...
        String texto =  "<html><body><p align='center'>MOTO DE CAMPO REGISTRADA CORRECTAMENTE</p><br>"
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("VOLVER")) {
			MenuFichaMotoDeCampo men = new MenuFichaMotoDeCampo();
			dispose();
			men.setVisible(true);
