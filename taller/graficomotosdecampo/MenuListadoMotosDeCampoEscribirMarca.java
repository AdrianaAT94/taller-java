...
public class MenuListadoMotosDeCampoEscribirMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMotosDeCampoEscribirMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MARCA DE MOTOS DE CAMPO");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoMotosDeCampoPorMarca men = new MenuListadoMotosDeCampoPorMarca();
			dispose();
			men.setVisible(true);
