...
public class MenuListadoMotosDeCampoEscribirMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMotosDeCampoEscribirMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MATRÍCULA DE MOTOS DE CAMPO");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuConsultaMotosDeCampo men = new MenuConsultaMotosDeCampo();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoMotosDeCampoPorMatricula men = new MenuListadoMotosDeCampoPorMatricula();
			dispose();
			men.setVisible(true);
