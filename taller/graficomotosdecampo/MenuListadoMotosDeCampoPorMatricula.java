...
public class MenuListadoMotosDeCampoPorMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMotosDeCampoPorMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE MOTOS DE CAMPO");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(cam.consultarporMatricula(MenuListadoMotosDeCampoEscribirMatricula.input.getText()));
