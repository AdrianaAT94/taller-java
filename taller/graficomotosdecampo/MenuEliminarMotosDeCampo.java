...
public class MenuEliminarMotosDeCampo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEliminarMotosDeCampo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("ELIMINAR MOTOS DE CAMPO");
