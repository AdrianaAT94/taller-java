...
public class MenuConsultaMotosDeCampo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuConsultaMotosDeCampo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("GESTIÓN DE MOTOS DE CAMPO");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("POR MATRÍCULA")) {
			MenuListadoMotosDeCampoEscribirMatricula men = new MenuListadoMotosDeCampoEscribirMatricula();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MARCA")) {
			MenuListadoMotosDeCampoEscribirMarca men = new MenuListadoMotosDeCampoEscribirMarca();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MODELO")) {
			MenuListadoMotosDeCampoEscribirModelo men = new MenuListadoMotosDeCampoEscribirModelo();
			dispose(); //elimina ventana
			men.setVisible(true);
