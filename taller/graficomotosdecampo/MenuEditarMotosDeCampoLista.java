...
public class MenuEditarMotosDeCampoLista extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarMotosDeCampoLista(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR MOTOS DE CAMPO");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Qué moto de campo quieres editar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("EDITAR")) {
			...
			MenuEditarMotoDeCampo men = new MenuEditarMotoDeCampo();
			dispose();
			men.setVisible(true);
