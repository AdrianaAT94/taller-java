...
public class MenuListadoMotosDeCampoPorModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMotosDeCampoPorModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(cam.consultarporModelo(MenuListadoMotosDeCampoEscribirModelo.input.getText()));
