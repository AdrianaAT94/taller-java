...
public class MenuListadoMotosDeCampoPorMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMotosDeCampoPorMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(cam.consultarporMarca(MenuListadoMotosDeCampoEscribirMarca.input.getText()));
