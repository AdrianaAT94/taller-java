...
public class MenuListadoMotosDeCampoEscribirModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMotosDeCampoEscribirModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MODELO DE MOTOS DE CAMPO");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoMotosDeCampoPorModelo men = new MenuListadoMotosDeCampoPorModelo();
			dispose();
			men.setVisible(true);
