...
public class MenuMotosDeCampo extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVA")) {
			MenuNuevaMotoDeCampo con = new MenuNuevaMotoDeCampo();
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaMotosDeCampo con = new MenuConsultaMotosDeCampo();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarMotosDeCampoLista con = new MenuEditarMotosDeCampoLista();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarMotosDeCampo con = new MenuEliminarMotosDeCampo();
			dispose(); //elimina ventana
			con.setVisible(true);
