...
public class MenuListadoComercialesEscribirApellidos extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoComercialesEscribirApellidos(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR APELLIDOS DE COMERCIALES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoComercialesPorApellidos men = new MenuListadoComercialesPorApellidos();
			dispose();
			men.setVisible(true);
