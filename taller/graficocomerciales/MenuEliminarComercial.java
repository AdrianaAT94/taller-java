...
public class MenuEliminarComercial extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEliminarComercial(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("ELIMINAR COMERCIALES");
        ...
        String nombreper = com.NombrePersona().toString();
        nombreper = nombreper.replace("[", "").replace("]", "");
        String[] parts = nombreper.split(",");
        String apellidoper = com.ApellidoPersona().toString();
        apellidoper = apellidoper.replace("[", "").replace("]", "");
        String[] parts2 = apellidoper.split(",");
        String idcomercial2 = com.IDPersona().toString();
        idcomercial2 = idcomercial2.replace("[", "").replace("]", "");
        String[] parts3 = idcomercial2.split(",");
