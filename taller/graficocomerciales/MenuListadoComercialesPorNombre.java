...
public class MenuListadoComercialesPorNombre extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoComercialesPorNombre(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(com.consultarporNombre(MenuListadoComercialesEscribirNombre.input.getText()));
