...
public class MenuListadoComercialesPorApellidos extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoComercialesPorApellidos(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE COMERCIALES");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(com.consultarporApellidos(MenuListadoComercialesEscribirApellidos.input.getText()));
