...
public class MenuComerciales extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVO")) {
			MenuNuevoComercial con = new MenuNuevoComercial();
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaComerciales con = new MenuConsultaComerciales();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarComercialLista con = new MenuEditarComercialLista();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarComercial con = new MenuEliminarComercial();
			dispose(); //elimina ventana
			con.setVisible(true);
