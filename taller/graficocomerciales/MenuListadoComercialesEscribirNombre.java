...
public class MenuListadoComercialesEscribirNombre extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoComercialesEscribirNombre(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR NOMBRE DE COMERCIALES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoComercialesPorNombre men = new MenuListadoComercialesPorNombre();
			dispose();
			men.setVisible(true);
