...
public class MenuListadoComercialesPorDNI extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoComercialesPorDNI(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(com.consultarporDNI(MenuListadoComercialesEscribirDNI.input.getText()));
