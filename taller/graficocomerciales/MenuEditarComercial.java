...
public class MenuEditarComercial extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarComercial(){
        ...
        com = new Comercial();
        sdni = com.getDni(MenuEditarComercialLista.id);
        snombre = com.getNombre(MenuEditarComercialLista.id);
        sapellidos = com.getApellidos(MenuEditarComercialLista.id);
        stelefono = com.getNumTelefono(MenuEditarComercialLista.id);
        scorreo = com.getCorreoElectronico(MenuEditarComercialLista.id);
        sdireccion = com.getDireccion(MenuEditarComercialLista.id);
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR COMERCIAL");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuComerciales men = new MenuComerciales();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			if (com.editar(MenuEditarComercialLista.id, inputnombre.getText(), inputapellidos.getText(), inputtelefono.getText(), inputcorreo.getText(), inputdireccion.getText())) {
				MenuListadoComerciales men = new MenuListadoComerciales();
				dispose();
				men.setVisible(true);
				...
				MenuErrorRegistroComercial men = new MenuErrorRegistroComercial();
				men.setVisible(true);
				dispose();
