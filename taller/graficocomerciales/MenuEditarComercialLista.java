...
public class MenuEditarComercialLista extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarComercialLista(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR COMERCIALES");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Qué comercial quieres editar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("EDITAR")) {
			...
			MenuEditarComercial men = new MenuEditarComercial();
			dispose();
			men.setVisible(true);
