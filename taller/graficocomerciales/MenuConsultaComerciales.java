...
public class MenuConsultaComerciales extends JFrame implements KeyListener, ActionListener {
	...
	public MenuConsultaComerciales(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("GESTIÓN DE COMERCIALES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("POR DNI")) {
			MenuListadoComercialesEscribirDNI men = new MenuListadoComercialesEscribirDNI();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR NOMBRE")) {
			MenuListadoComercialesEscribirNombre men = new MenuListadoComercialesEscribirNombre();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR APELLIDOS")) {
			MenuListadoComercialesEscribirApellidos men = new MenuListadoComercialesEscribirApellidos();
			dispose(); //elimina ventana
			men.setVisible(true);
