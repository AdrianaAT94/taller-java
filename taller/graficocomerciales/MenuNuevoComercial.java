...
public class MenuNuevoComercial extends JFrame implements KeyListener, ActionListener {
	...
	public MenuNuevoComercial(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("REGISTRO DE NUEVO COMERCIAL");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			if (com.insertar(inputdni.getText(), inputnombre.getText(), inputapellidos.getText(), inputtelefono.getText(), inputcorreo.getText(), inputdireccion.getText())) {
