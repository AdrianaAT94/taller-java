...
public class MenuListadoMecanicosPorApellidos extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMecanicosPorApellidos(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE MECÁNICOS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(mec.consultarporApellidos(MenuListadoMecanicosEscribirApellidos.input.getText()));
