...
public class MenuListadoMecanicosEscribirDNI extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMecanicosEscribirDNI(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR DNI DE MECANICOS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoMecanicosPorDNI men = new MenuListadoMecanicosPorDNI();
			dispose();
			men.setVisible(true);
