...
public class MenuListadoMecanicosEscribirNombre extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMecanicosEscribirNombre(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR NOMBRE DE MECANICOS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoMecanicosPorNombre men = new MenuListadoMecanicosPorNombre();
			dispose();
			men.setVisible(true);
