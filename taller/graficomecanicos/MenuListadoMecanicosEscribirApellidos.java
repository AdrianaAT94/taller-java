...
public class MenuListadoMecanicosEscribirApellidos extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMecanicosEscribirApellidos(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR APELLIDOS DE MECANICOS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuConsultaMecanicos men = new MenuConsultaMecanicos();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoMecanicosPorApellidos men = new MenuListadoMecanicosPorApellidos();
			dispose();
			men.setVisible(true);
