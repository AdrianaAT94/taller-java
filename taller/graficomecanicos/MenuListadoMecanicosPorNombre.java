...
public class MenuListadoMecanicosPorNombre extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMecanicosPorNombre(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(mec.consultarporNombre(MenuListadoMecanicosEscribirNombre.input.getText()));
