...
public class MenuNuevoMecanico extends JFrame implements KeyListener, ActionListener {
	...
	public MenuNuevoMecanico(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("REGISTRO DE NUEVO MECÁNICO");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			if (mec.insertar(inputdni.getText(), inputnombre.getText(), inputapellidos.getText(), inputtelefono.getText(), inputcorreo.getText(), inputdireccion.getText())) {
