...
public class MenuListadoMecanicosPorDNI extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMecanicosPorDNI(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(mec.consultarporDNI(MenuListadoMecanicosEscribirDNI.input.getText()));
