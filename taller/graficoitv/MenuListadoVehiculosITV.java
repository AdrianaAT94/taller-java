...
public class MenuListadoVehiculosITV extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoVehiculosITV(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE VEHÍCULOS PARA ITV");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(itv.listar());
