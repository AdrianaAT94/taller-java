...
public class MenuFichaAmbulancia extends JFrame implements KeyListener, ActionListener {
	...
	public MenuFichaAmbulancia(){
        ...
        fic = new Ficha();
        amb = new Ambulancia();
        sfechaEntrada = amb.getfechaAlta(amb.getUltimoRegitro());
        scliente = amb.getNombrecliente(amb.getUltimoRegitro());
        svehiculo = amb.getNombrevehiculo(amb.getUltimoRegitro());
...
idvehi = amb.getUltimoRegitro();
		
		if (amb.getCombustible(idvehi).equals("diésel")){
			inputdescripcion.setText("Revisión del filtro de partículas");
			if (amb.getNombretipovehiculo(idvehi).equals("Ambulancia") || amb.getNombretipovehiculo(idvehi).equals("Bomberos") || amb.getNombretipovehiculo(idvehi).equals("Policía")) {
				inputdescripcion.setText("Revisión del filtro de partículas, Revisión de la sirena");	
			}
		}
		else if (amb.getnRuedas(idvehi).equals("2")) {
		...
		else if (amb.getNombretipovehiculo(idvehi).equals("Ambulancia") || amb.getNombretipovehiculo(idvehi).equals("Bomberos") || amb.getNombretipovehiculo(idvehi).equals("Policía")) {
	...
	public void actionPerformed(ActionEvent e) {		
		...
		if (e.getActionCommand().equals("ENVIAR")) {
				...
				if (fic.editar(amb.getUltimoRegitro(), inputdescripcion.getText(), sest, inputfechaSalida.getText(), inputmotivo.getText())) {
