...
public class MenuListadoAmbulanciasEscribirMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoAmbulanciasEscribirMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MARCA DE AMBULANCIAS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoAmbulanciasPorMarca men = new MenuListadoAmbulanciasPorMarca();
			dispose();
			men.setVisible(true);
