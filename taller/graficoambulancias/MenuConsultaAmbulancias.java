...
public class MenuConsultaAmbulancias extends JFrame implements KeyListener, ActionListener {
	...
	public MenuConsultaAmbulancias(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("GESTIÓN DE AMBULANCIAS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("POR MATRÍCULA")) {
			MenuListadoAmbulanciasEscribirMatricula men = new MenuListadoAmbulanciasEscribirMatricula();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MARCA")) {
			MenuListadoAmbulanciasEscribirMarca men = new MenuListadoAmbulanciasEscribirMarca();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MODELO")) {
			MenuListadoAmbulanciasEscribirModelo men = new MenuListadoAmbulanciasEscribirModelo();
			dispose(); //elimina ventana
			men.setVisible(true);
