...
public class MenuAmbulancias extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVA")) {
			MenuNuevaAmbulancia con = new MenuNuevaAmbulancia();
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaAmbulancias con = new MenuConsultaAmbulancias();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarAmbulanciaLista con = new MenuEditarAmbulanciaLista();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarAmbulancia con = new MenuEliminarAmbulancia();
			dispose(); //elimina ventana
			con.setVisible(true);
