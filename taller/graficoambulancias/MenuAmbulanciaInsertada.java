...
public class MenuAmbulanciaInsertada extends JFrame implements KeyListener, ActionListener{
	...
	public MenuAmbulanciaInsertada() {
		super("Taller"); //Nome
        ...
        String texto =  "<html><body><p align='center'>AMBULANCIA REGISTRADA CORRECTAMENTE</p><br>"
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("VOLVER")) {
			MenuFichaAmbulancia men = new MenuFichaAmbulancia();
			dispose();
			men.setVisible(true);
