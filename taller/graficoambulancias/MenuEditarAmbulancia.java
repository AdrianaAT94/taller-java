...
public class MenuEditarAmbulancia extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarAmbulancia(){
        ...
        smatricula = amb.getMatricula(MenuEditarAmbulanciaLista.id);
        smarca = amb.getMarca(MenuEditarAmbulanciaLista.id);
        smodelo = amb.getModelo(MenuEditarAmbulanciaLista.id);
        scombustible = amb.getCombustible(MenuEditarAmbulanciaLista.id);
        snPuertas = amb.getnPuertas(MenuEditarAmbulanciaLista.id);
        snRuedas = amb.getnRuedas(MenuEditarAmbulanciaLista.id);
        smaxVelocidad = amb.getMaxVelocidad(MenuEditarAmbulanciaLista.id);
        scapMotor = amb.getCapMotor(MenuEditarAmbulanciaLista.id);
        scapAlmacenamiento = amb.getCapAlmacenamiento(MenuEditarAmbulanciaLista.id);
        snPasajeros = amb.getnPasajeros(MenuEditarAmbulanciaLista.id);
        sABS = amb.isABS(MenuEditarAmbulanciaLista.id);
        sGPS = amb.isGPS(MenuEditarAmbulanciaLista.id);
        sairbags = amb.isAirbags(MenuEditarAmbulanciaLista.id);
        sclimatizacion = amb.isClimatizacion(MenuEditarAmbulanciaLista.id);
        sdescapotable = amb.isDescapotable(MenuEditarAmbulanciaLista.id);
        sduenho = amb.getIdcliente(MenuEditarAmbulanciaLista.id);
        smotivoVisita = amb.getMotivoVisita(MenuEditarAmbulanciaLista.id);
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR AMBULANCIA");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuAmbulancias men = new MenuAmbulancias();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			...
			if (amb.editar(MenuEditarAmbulanciaLista.id, inputmarca.getText(), inputmodelo.getText(), inputmatricula.getText(), combus, inputnPuertas.getText(), inputnRuedas.getText(), inputmaxVelocidad.getText(), inputcapMotor.getText(), inputcapAlmacenamiento.getText(), inputnPasajeros.getText(), a, g, airb, clim, des, idcli, inputmotivoVisita.getText())) {
				MenuListadoAmbulancias men = new MenuListadoAmbulancias();
				dispose();
				men.setVisible(true);
				...
				MenuErrorRegistroAmbulancia men = new MenuErrorRegistroAmbulancia();
				men.setVisible(true);
				dispose();
