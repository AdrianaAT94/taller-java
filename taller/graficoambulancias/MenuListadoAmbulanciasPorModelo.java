...
public class MenuListadoAmbulanciasPorModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoAmbulanciasPorModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(amb.consultarporModelo(MenuListadoAmbulanciasEscribirModelo.input.getText()));
