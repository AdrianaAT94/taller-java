...
public class MenuListadoAmbulanciasEscribirMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoAmbulanciasEscribirMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MATRÍCULA DE AMBULANCIAS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuConsultaAmbulancias men = new MenuConsultaAmbulancias();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoAmbulanciasPorMatricula men = new MenuListadoAmbulanciasPorMatricula();
			dispose();
			men.setVisible(true);
