...
public class MenuListadoAmbulanciasPorMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoAmbulanciasPorMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE AMBULANCIAS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(amb.consultarporMatricula(MenuListadoAmbulanciasEscribirMatricula.input.getText()));
