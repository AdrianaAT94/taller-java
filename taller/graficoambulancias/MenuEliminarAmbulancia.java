...
public class MenuEliminarAmbulancia extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEliminarAmbulancia(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("ELIMINAR AMBULANCIA");
