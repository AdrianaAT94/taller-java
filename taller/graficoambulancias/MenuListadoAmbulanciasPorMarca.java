...
public class MenuListadoAmbulanciasPorMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoAmbulanciasPorMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(amb.consultarporMarca(MenuListadoAmbulanciasEscribirMarca.input.getText()));
