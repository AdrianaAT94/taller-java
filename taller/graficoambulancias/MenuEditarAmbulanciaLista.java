...
public class MenuEditarAmbulanciaLista extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarAmbulanciaLista(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR AMBULANCIAS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Qué ambulancia quieres editar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("EDITAR")) {
			...
			MenuEditarAmbulancia men = new MenuEditarAmbulancia();
			dispose();
			men.setVisible(true);
