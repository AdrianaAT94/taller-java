...
public class MenuListadoAmbulanciasEscribirModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoAmbulanciasEscribirModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MODELO DE AMBULANCIAS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoAmbulanciasPorModelo men = new MenuListadoAmbulanciasPorModelo();
			dispose();
			men.setVisible(true);
