...
public class Comercial extends Persona
{
	...
	public boolean insertar(String dni, String nombre, String apellidos, String numTelefono, String correoElectronico, String direccion) {		
    	...
    	try {
	        String sql = "INSERT INTO persona (`dni`, `nombre`, `apellidos`, `telf`, `correo`, `direccion`, `fechaAlta`, `tipoPersona`) VALUES ("
	        		+"'"+dni+"','"+nombre+"','"+apellidos+"','"+numTelefono+"','"+correoElectronico+"','"+direccion+"','"+fechaAlta+"','3')";
	...
	public String listar() {
		...
		try {
			resultado = sentencia.executeQuery("SELECT * FROM persona WHERE tipoPersona = '3'");
	...
	public String consultarporDNI(String dni) {
		...
		try {
			resultado = sentencia.executeQuery("SELECT * FROM persona WHERE UPPER(dni) LIKE UPPER('%"+dni+"%') AND tipoPersona='3'"); 
	...
	public String consultarporNombre(String nombre) {
		...
		try {
			resultado = sentencia.executeQuery("SELECT * FROM persona WHERE UPPER(nombre) LIKE UPPER('%"+nombre+"%') AND tipoPersona='3'");
	...
	public String consultarporApellidos(String apellidos) {
		...
		try {
			resultado = sentencia.executeQuery("SELECT * FROM persona WHERE UPPER(apellidos) LIKE UPPER('%"+apellidos+"%') AND tipoPersona='3'");
