...
public class MenuListadoOfertas extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoOfertas(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE OFERTAS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(ofe.listar());
