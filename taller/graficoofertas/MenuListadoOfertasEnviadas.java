...
public class MenuListadoOfertasEnviadas extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoOfertasEnviadas(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE OFERTAS ENVIADAS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(ofe.listarEnv());
