...
public class MenuListadoCochesPoliciaPorMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCochesPoliciaPorMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE COCHES DE POLICÍAS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(pol.consultarporMatricula(MenuListadoCochesPoliciaEscribirMatricula.input.getText()));
