...
public class MenuConsultaCochesPolicia extends JFrame implements KeyListener, ActionListener {
	...
	public MenuConsultaCochesPolicia(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("GESTIÓN DE COCHES DE POLICÍA");        
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("POR MATRÍCULA")) {
			MenuListadoCochesPoliciaEscribirMatricula men = new MenuListadoCochesPoliciaEscribirMatricula();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MARCA")) {
			MenuListadoCochesPoliciaEscribirMarca men = new MenuListadoCochesPoliciaEscribirMarca();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MODELO")) {
			MenuListadoCochesPoliciaEscribirModelo men = new MenuListadoCochesPoliciaEscribirModelo();
			dispose(); //elimina ventana
			men.setVisible(true);
