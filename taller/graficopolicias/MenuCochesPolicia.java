...
public class MenuCochesPolicia extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVO")) {
			MenuNuevoCochePolicia men = new MenuNuevoCochePolicia();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaCochesPolicia con = new MenuConsultaCochesPolicia();
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarCochePoliciaLista con = new MenuEditarCochePoliciaLista();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarCochePolicia con = new MenuEliminarCochePolicia();
			dispose(); //elimina ventana
			con.setVisible(true);
