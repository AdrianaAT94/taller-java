...
public class MenuListadoCochesPoliciaPorModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCochesPoliciaPorModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(pol.consultarporModelo(MenuListadoCochesPoliciaEscribirModelo.input.getText()));
