...
public class MenuEditarCochePolicia extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarCochePolicia(){
        ...
        smatricula = pol.getMatricula(MenuEditarCochePoliciaLista.id);
        smarca = pol.getMarca(MenuEditarCochePoliciaLista.id);
        smodelo = pol.getModelo(MenuEditarCochePoliciaLista.id);
        scombustible = pol.getCombustible(MenuEditarCochePoliciaLista.id);
        snPuertas = pol.getnPuertas(MenuEditarCochePoliciaLista.id);
        snRuedas = pol.getnRuedas(MenuEditarCochePoliciaLista.id);
        smaxVelocidad = pol.getMaxVelocidad(MenuEditarCochePoliciaLista.id);
        scapMotor = pol.getCapMotor(MenuEditarCochePoliciaLista.id);
        scapAlmacenamiento = pol.getCapAlmacenamiento(MenuEditarCochePoliciaLista.id);
        snPasajeros = pol.getnPasajeros(MenuEditarCochePoliciaLista.id);
        sABS = pol.isABS(MenuEditarCochePoliciaLista.id);
        sGPS = pol.isGPS(MenuEditarCochePoliciaLista.id);
        sairbags = pol.isAirbags(MenuEditarCochePoliciaLista.id);
        sclimatizacion = pol.isClimatizacion(MenuEditarCochePoliciaLista.id);
        sdescapotable = pol.isDescapotable(MenuEditarCochePoliciaLista.id);
        sduenho = pol.getIdcliente(MenuEditarCochePoliciaLista.id);
        smotivoVisita = pol.getMotivoVisita(MenuEditarCochePoliciaLista.id);
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR COCHE DE POLICÍA");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			...
			if (pol.editar(MenuEditarCochePoliciaLista.id, inputmarca.getText(), inputmodelo.getText(), inputmatricula.getText(), combus, inputnPuertas.getText(), inputnRuedas.getText(), inputmaxVelocidad.getText(), inputcapMotor.getText(), inputcapAlmacenamiento.getText(), inputnPasajeros.getText(), a, g, airb, clim, des, idcli, inputmotivoVisita.getText())) {
