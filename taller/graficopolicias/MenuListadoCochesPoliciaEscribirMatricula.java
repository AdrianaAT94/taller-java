...
public class MenuListadoCochesPoliciaEscribirMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCochesPoliciaEscribirMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MATRÍCULA DE COCHES DE POLICÍA");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuConsultaCochesPolicia men = new MenuConsultaCochesPolicia();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoCochesPoliciaPorMatricula men = new MenuListadoCochesPoliciaPorMatricula();
			dispose();
			men.setVisible(true);
