...
public class MenuCochePoliciaInsertado extends JFrame implements KeyListener, ActionListener{
	...
	public MenuCochePoliciaInsertado() {
		super("Taller"); //Nome
        ...
        String texto =  "<html><body><p align='center'>COCHE DE POLICÕA REGISTRADO CORRECTAMENTE</p><br>"
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("VOLVER")) {
			MenuFichaCochePolicia men = new MenuFichaCochePolicia();
			dispose();
			men.setVisible(true);
