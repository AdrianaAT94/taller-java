...
public class MenuEditarCochePoliciaLista extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarCochePoliciaLista(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR COCHES DE POLICÍA");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Qué coche de policía quieres editar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("EDITAR")) {
			...
			MenuEditarCochePolicia men = new MenuEditarCochePolicia();
			dispose();
			men.setVisible(true);
