...
public class MenuListadoCochesPoliciaEscribirModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCochesPoliciaEscribirModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MODELO DE COCHES DE POLICÍA");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoCochesPoliciaPorModelo men = new MenuListadoCochesPoliciaPorModelo();
			dispose();
			men.setVisible(true);
