...
public class MenuListadoCochesPoliciaPorMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCochesPoliciaPorMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(pol.consultarporMarca(MenuListadoCochesPoliciaEscribirMarca.input.getText()));
