...
public class MenuListadoCochesPolicia extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCochesPolicia(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(pol.listar());
