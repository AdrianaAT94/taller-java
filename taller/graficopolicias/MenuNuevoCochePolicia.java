...
public class MenuNuevoCochePolicia extends JFrame implements KeyListener, ActionListener {
	...
	public MenuNuevoCochePolicia(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("REGISTRO DE NUEVO COCHE DE POLICÍA");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			...
			if (pol.insertar(inputmarca.getText(), inputmodelo.getText(), inputmatricula.getText(), combus, inputnPuertas.getText(), inputnRuedas.getText(), inputmaxVelocidad.getText(), inputcapMotor.getText(), inputcapAlmacenamiento.getText(), inputnPasajeros.getText(), a, g, airb, clim, des, id, inputmotivoVisita.getText())) {
				...
				try {
					archivo = new FileOutputStream("descargas/permisos_cochesdepolicia/"+inputmatricula.getText()+"-"+fecha+".pdf");
					Document documento = new Document();
					PdfWriter.getInstance(documento, archivo);
					documento.open();
					Paragraph titulo = new Paragraph("NUEVO COCHE DE POLICÍA");
				...
				MenuCochePoliciaInsertado men = new MenuCochePoliciaInsertado();
				dispose();
				men.setVisible(true);
