...
public class MenuListadoCochesPoliciaEscribirMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCochesPoliciaEscribirMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MARCA DE COCHES DE POLICÍA");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoCochesPoliciaPorMarca men = new MenuListadoCochesPoliciaPorMarca();
			dispose();
			men.setVisible(true);
