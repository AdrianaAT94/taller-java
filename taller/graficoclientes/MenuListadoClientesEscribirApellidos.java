...
public class MenuListadoClientesEscribirApellidos extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoClientesPorApellidos men = new MenuListadoClientesPorApellidos();
			dispose();
			men.setVisible(true);
