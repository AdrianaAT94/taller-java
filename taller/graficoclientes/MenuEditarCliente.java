...
public class MenuEditarCliente extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarCliente(){
        ...
        scorreo = cl.getCorreoElectronico(MenuEditarClienteLista.id);
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			if (cl.editar(MenuEditarClienteLista.id, inputnombre.getText(), inputapellidos.getText(), inputtelefono.getText(), inputcorreo.getText(), inputdireccion.getText())) {
				...
				MenuErrorRegistroCliente men = new MenuErrorRegistroCliente();
				men.setVisible(true);
				dispose();
