...
public class MenuConsultaClientes extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("POR DNI")) {
			MenuListadoClientesEscribirDNI men = new MenuListadoClientesEscribirDNI();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR NOMBRE")) {
			MenuListadoClientesEscribirNombre men = new MenuListadoClientesEscribirNombre();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR APELLIDOS")) {
			MenuListadoClientesEscribirApellidos men = new MenuListadoClientesEscribirApellidos();
			dispose(); //elimina ventana
			men.setVisible(true);
