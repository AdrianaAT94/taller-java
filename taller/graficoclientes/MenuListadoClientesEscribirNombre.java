...
public class MenuListadoClientesEscribirNombre extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoClientesPorNombre men = new MenuListadoClientesPorNombre();
			dispose();
			men.setVisible(true);
