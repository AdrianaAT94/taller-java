...
public class MenuListadoClientesPorDNI extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoClientesPorDNI(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(cl.consultarporDNI(MenuListadoClientesEscribirDNI.input.getText()));
