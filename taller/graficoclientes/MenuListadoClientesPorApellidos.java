...
public class MenuListadoClientesPorApellidos extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoClientesPorApellidos(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(cl.consultarporApellidos(MenuListadoClientesEscribirApellidos.input.getText()));
