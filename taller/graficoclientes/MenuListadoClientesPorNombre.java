...
public class MenuListadoClientesPorNombre extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoClientesPorNombre(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(cl.consultarporNombre(MenuListadoClientesEscribirNombre.input.getText()));
