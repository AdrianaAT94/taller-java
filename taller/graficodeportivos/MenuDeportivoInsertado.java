...
public class MenuDeportivoInsertado extends JFrame implements KeyListener, ActionListener{
	...
	public MenuDeportivoInsertado() {
        ...
        String texto =  "<html><body><p align='center'>DEPORTIVO REGISTRADO CORRECTAMENTE</p><br>"
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("VOLVER")) {
			MenuFichaDeportivo men = new MenuFichaDeportivo();
			dispose();
			men.setVisible(true);
