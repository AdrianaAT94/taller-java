...
public class MenuListadoDeportivosEscribirModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoDeportivosEscribirModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MODELO DE DEPORTIVOS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoDeportivosPorModelo men = new MenuListadoDeportivosPorModelo();
			dispose();
			men.setVisible(true);
