...
public class MenuListadoDeportivosEscribirMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoDeportivosEscribirMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MATRÍCULA DE DEPORTIVOD");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuConsultaDeportivos men = new MenuConsultaDeportivos();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoDeportivosPorMatricula men = new MenuListadoDeportivosPorMatricula();
			dispose();
			men.setVisible(true);
