...
public class MenuListadoDeportivosEscribirMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoDeportivosEscribirMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MARCA DE DEPORTIVOS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoDeportivosPorMarca men = new MenuListadoDeportivosPorMarca();
			dispose();
			men.setVisible(true);
