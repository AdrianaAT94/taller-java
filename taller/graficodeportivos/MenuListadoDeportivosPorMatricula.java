...
public class MenuListadoDeportivosPorMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoDeportivosPorMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(dep.consultarporMatricula(MenuListadoDeportivosEscribirMatricula.input.getText()));
