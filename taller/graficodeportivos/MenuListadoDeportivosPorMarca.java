...
public class MenuListadoDeportivosPorMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoDeportivosPorMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(dep.consultarporMarca(MenuListadoDeportivosEscribirMarca.input.getText()));
