...
public class MenuEditarDeportivoLista extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarDeportivoLista(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR DEPORTIVOS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Qué deportivo quieres editar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("EDITAR")) {
			...
			MenuEditarDeportivo men = new MenuEditarDeportivo();
			dispose();
			men.setVisible(true);
