...
public class MenuListadoDeportivosPorModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoDeportivosPorModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE DEPORTIVOS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(dep.consultarporModelo(MenuListadoDeportivosEscribirModelo.input.getText()));
