...
public class MenuDeportivos extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVO")) {
			MenuNuevoDeportivo con = new MenuNuevoDeportivo();
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaDeportivos con = new MenuConsultaDeportivos();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarDeportivoLista con = new MenuEditarDeportivoLista();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarDeportivo con = new MenuEliminarDeportivo();
			dispose(); //elimina ventana
			con.setVisible(true);
