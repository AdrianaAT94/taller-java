...
public class MenuListadoAutobusesPorMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoAutobusesPorMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(aut.consultarporMarca(MenuListadoAutobusesEscribirMarca.input.getText()));
