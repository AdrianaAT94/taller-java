...
public class MenuFichaAutobus extends JFrame implements KeyListener, ActionListener {
	...
	public MenuFichaAutobus(){
        ...
        fic = new Ficha();
        aut = new Autobus();
        sfechaEntrada = aut.getfechaAlta(aut.getUltimoRegitro());
        scliente = aut.getNombrecliente(aut.getUltimoRegitro());
        svehiculo = aut.getNombrevehiculo(aut.getUltimoRegitro());
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        idvehi = aut.getUltimoRegitro();
		
		if (aut.getCombustible(idvehi).equals("diésel")){
			inputdescripcion.setText("Revisión del filtro de partículas");
			if (aut.getNombretipovehiculo(idvehi).equals("Ambulancia") || aut.getNombretipovehiculo(idvehi).equals("Bomberos") || aut.getNombretipovehiculo(idvehi).equals("Policía")) {
				inputdescripcion.setText("Revisión del filtro de partículas, Revisión de la sirena");	
			}
		}
		else if (aut.getnRuedas(idvehi).equals("2")) {
		...
		else if (aut.getNombretipovehiculo(idvehi).equals("Ambulancia") || aut.getNombretipovehiculo(idvehi).equals("Bomberos") || aut.getNombretipovehiculo(idvehi).equals("Policía")) {
	...
	public void actionPerformed(ActionEvent e) {		
		...
		if (e.getActionCommand().equals("ENVIAR")) {
				...
				if (fic.editar(aut.getUltimoRegitro(), inputdescripcion.getText(), sest, inputfechaSalida.getText(), inputmotivo.getText())) {
