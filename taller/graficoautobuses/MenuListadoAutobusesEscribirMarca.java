...
public class MenuListadoAutobusesEscribirMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoAutobusesEscribirMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MARCA DE AUTOBUSES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoAutobusesPorMarca men = new MenuListadoAutobusesPorMarca();
			dispose();
			men.setVisible(true);
