...
public class MenuEliminarAutobus extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEliminarAutobus(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("ELIMINAR AUTOBUS");
