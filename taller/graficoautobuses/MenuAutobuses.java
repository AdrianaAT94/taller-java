...
public class MenuAutobuses extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVO")) {
			MenuNuevoAutobus con = new MenuNuevoAutobus();
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaAutobuses con = new MenuConsultaAutobuses();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarAutobusLista con = new MenuEditarAutobusLista();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarAutobus con = new MenuEliminarAutobus();
			dispose(); //elimina ventana
			con.setVisible(true);
