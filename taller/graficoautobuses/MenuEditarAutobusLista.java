...
public class MenuEditarAutobusLista extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarAutobusLista(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR AUTOBUSES");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Qué autobús quieres editar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("EDITAR")) {
			...
			MenuEditarAutobus men = new MenuEditarAutobus();
			dispose();
			men.setVisible(true);
