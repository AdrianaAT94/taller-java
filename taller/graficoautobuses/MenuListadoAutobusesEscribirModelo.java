...
public class MenuListadoAutobusesEscribirModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoAutobusesEscribirModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MODELO DE AUTOBUSES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoAutobusesPorModelo men = new MenuListadoAutobusesPorModelo();
			dispose();
			men.setVisible(true);
