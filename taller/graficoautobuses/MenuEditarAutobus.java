...
public class MenuEditarAutobus extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarAutobus(){
        ...
        smatricula = aut.getMatricula(MenuEditarAutobusLista.id);
        smarca = aut.getMarca(MenuEditarAutobusLista.id);
        smodelo = aut.getModelo(MenuEditarAutobusLista.id);
        scombustible = aut.getCombustible(MenuEditarAutobusLista.id);
        snPuertas = aut.getnPuertas(MenuEditarAutobusLista.id);
        snRuedas = aut.getnRuedas(MenuEditarAutobusLista.id);
        smaxVelocidad = aut.getMaxVelocidad(MenuEditarAutobusLista.id);
        scapMotor = aut.getCapMotor(MenuEditarAutobusLista.id);
        scapAlmacenamiento = aut.getCapAlmacenamiento(MenuEditarAutobusLista.id);
        snPasajeros = aut.getnPasajeros(MenuEditarAutobusLista.id);
        sABS = aut.isABS(MenuEditarAutobusLista.id);
        sGPS = aut.isGPS(MenuEditarAutobusLista.id);
        sairbags = aut.isAirbags(MenuEditarAutobusLista.id);
        sclimatizacion = aut.isClimatizacion(MenuEditarAutobusLista.id);
        sdescapotable = aut.isDescapotable(MenuEditarAutobusLista.id);
        sduenho = aut.getIdcliente(MenuEditarAutobusLista.id);
        smotivoVisita = aut.getMotivoVisita(MenuEditarAutobusLista.id);
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR AUTOBUS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuAutobuses men = new MenuAutobuses();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
	        ...
	        if (aut.editar(MenuEditarAutobusLista.id, inputmarca.getText(), inputmodelo.getText(), inputmatricula.getText(), combus, inputnPuertas.getText(), inputnRuedas.getText(), inputmaxVelocidad.getText(), inputcapMotor.getText(), inputcapAlmacenamiento.getText(), inputnPasajeros.getText(), a, g, airb, clim, des, idcli, inputmotivoVisita.getText())) {
				MenuListadoAutobuses men = new MenuListadoAutobuses();
				dispose();
				men.setVisible(true);
				...
				MenuErrorRegistroAutobus men = new MenuErrorRegistroAutobus();
				men.setVisible(true);
				dispose();
