...
public class MenuListadoAutobusesPorModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoAutobusesPorModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(aut.consultarporModelo(MenuListadoAutobusesEscribirModelo.input.getText()));
