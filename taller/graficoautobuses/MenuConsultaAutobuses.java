...
public class MenuConsultaAutobuses extends JFrame implements KeyListener, ActionListener {
	...
	public MenuConsultaAutobuses(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("GESTIÓN DE AUTOBUSES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("POR MATRÍCULA")) {
			MenuListadoAutobusesEscribirMatricula men = new MenuListadoAutobusesEscribirMatricula();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MARCA")) {
			MenuListadoAutobusesEscribirMarca men = new MenuListadoAutobusesEscribirMarca();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MODELO")) {
			MenuListadoAutobusesEscribirModelo men = new MenuListadoAutobusesEscribirModelo();
			dispose(); //elimina ventana
			men.setVisible(true);
