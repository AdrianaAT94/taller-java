...
public class MenuListadoAutobusesEscribirMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoAutobusesEscribirMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MATRÍCULA DE AUTOBUSES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuConsultaAutobuses men = new MenuConsultaAutobuses();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoAutobusesPorMatricula men = new MenuListadoAutobusesPorMatricula();
			dispose();
			men.setVisible(true);
