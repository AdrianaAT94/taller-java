...
public class MenuListadoAutobusesPorMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoAutobusesPorMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE AUTOBUSES");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(aut.consultarporMatricula(MenuListadoAutobusesEscribirMatricula.input.getText()));
