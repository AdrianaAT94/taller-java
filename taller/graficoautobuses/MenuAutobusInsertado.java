...
public class MenuAutobusInsertado extends JFrame implements KeyListener, ActionListener{
	...
	public MenuAutobusInsertado() {
        ...
        String texto =  "<html><body><p align='center'>AUTOB⁄S REGISTRADO CORRECTAMENTE</p><br>"
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("VOLVER")) {
			MenuFichaAutobus men = new MenuFichaAutobus();
			dispose();
			men.setVisible(true);
