...
public class MenuTodoterrenos extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVO")) {
			MenuNuevoTodoterreno con = new MenuNuevoTodoterreno();
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaTodoterrenos con = new MenuConsultaTodoterrenos();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarTodoterrenoLista con = new MenuEditarTodoterrenoLista();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarTodoterreno con = new MenuEliminarTodoterreno();
			dispose(); //elimina ventana
			con.setVisible(true);
