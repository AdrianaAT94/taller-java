...
public class MenuFichaTodoterreno extends JFrame implements KeyListener, ActionListener {
	...
	public MenuFichaTodoterreno(){
        ...
        setResizable(false); //Que non se poda ctodiar o tamaanho da ventana
        ...
        fic = new Ficha();
        tod = new Todoterreno();
        sfechaEntrada = tod.getfechaAlta(tod.getUltimoRegitro());
        scliente = tod.getNombrecliente(tod.getUltimoRegitro());
        svehiculo = tod.getNombrevehiculo(tod.getUltimoRegitro());
...
idvehi = tod.getUltimoRegitro();
		
		if (tod.getCombustible(idvehi).equals("diésel")){
			inputdescripcion.setText("Revisión del filtro de partículas");
			if (tod.getNombretipovehiculo(idvehi).equals("todulancia") || tod.getNombretipovehiculo(idvehi).equals("Bomberos") || tod.getNombretipovehiculo(idvehi).equals("Policía")) {
				inputdescripcion.setText("Revisión del filtro de partículas, Revisión de la sirena");	
			}
		}
		else if (tod.getnRuedas(idvehi).equals("2")) {
		...
		else if (tod.getNombretipovehiculo(idvehi).equals("todulancia") || tod.getNombretipovehiculo(idvehi).equals("Bomberos") || tod.getNombretipovehiculo(idvehi).equals("Policía")) {
	...
	public void actionPerformed(ActionEvent e) {		
		...
		if (e.getActionCommand().equals("ENVIAR")) {
				...
				if (fic.editar(tod.getUltimoRegitro(), inputdescripcion.getText(), sest, inputfechaSalida.getText(), inputmotivo.getText())) {
