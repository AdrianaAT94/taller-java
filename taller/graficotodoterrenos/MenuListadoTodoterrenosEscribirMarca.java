...
public class MenuListadoTodoterrenosEscribirMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoTodoterrenosEscribirMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MARCA DE TODOTERRENOS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoTodoterrenosPorMarca men = new MenuListadoTodoterrenosPorMarca();
			dispose();
			men.setVisible(true);
