...
public class MenuListadoTodoterrenosEscribirMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoTodoterrenosEscribirMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MATRÍCULA DE TODOTERRENOS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuConsultaTodoterrenos men = new MenuConsultaTodoterrenos();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoTodoterrenosPorMatricula men = new MenuListadoTodoterrenosPorMatricula();
			dispose();
			men.setVisible(true);
