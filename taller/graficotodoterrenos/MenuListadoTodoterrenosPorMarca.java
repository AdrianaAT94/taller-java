...
public class MenuListadoTodoterrenosPorMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoTodoterrenosPorMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(tod.consultarporMarca(MenuListadoTodoterrenosEscribirMarca.input.getText()));
