...
public class MenuListadoTodoterrenosEscribirModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoTodoterrenosEscribirModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MODELO DE TODOTERRENOS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoTodoterrenosPorModelo men = new MenuListadoTodoterrenosPorModelo();
			dispose();
			men.setVisible(true);
