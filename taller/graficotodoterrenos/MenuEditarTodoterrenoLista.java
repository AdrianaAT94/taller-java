...
public class MenuEditarTodoterrenoLista extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarTodoterrenoLista(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR TODOTERRENOS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Qué todoterreno quieres editar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("EDITAR")) {
			...
			MenuEditarTodoterreno men = new MenuEditarTodoterreno();
			dispose();
			men.setVisible(true);
