...
public class MenuConsultaTodoterrenos extends JFrame implements KeyListener, ActionListener {
	...
	public MenuConsultaTodoterrenos(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("GESTIÓN DE TODOTERRENOS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("POR MATRÍCULA")) {
			MenuListadoTodoterrenosEscribirMatricula men = new MenuListadoTodoterrenosEscribirMatricula();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MARCA")) {
			MenuListadoTodoterrenosEscribirMarca men = new MenuListadoTodoterrenosEscribirMarca();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MODELO")) {
			MenuListadoTodoterrenosEscribirModelo men = new MenuListadoTodoterrenosEscribirModelo();
			dispose(); //elimina ventana
			men.setVisible(true);
