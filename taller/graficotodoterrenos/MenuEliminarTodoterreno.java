...
public class MenuEliminarTodoterreno extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEliminarTodoterreno(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("ELIMINAR TODOTERRENO");
