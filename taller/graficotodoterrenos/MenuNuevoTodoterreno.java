...
public class MenuNuevoTodoterreno extends JFrame implements KeyListener, ActionListener {
	...
	public MenuNuevoTodoterreno(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("REGISTRO DE NUEVO TODOTERRENO");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			...
			if (tod.insertar(inputmarca.getText(), inputmodelo.getText(), inputmatricula.getText(), combus, inputnPuertas.getText(), inputnRuedas.getText(), inputmaxVelocidad.getText(), inputcapMotor.getText(), inputcapAlmacenamiento.getText(), inputnPasajeros.getText(), a, g, airb, clim, des, id, inputmotivoVisita.getText())) {
				...
				try {
					archivo = new FileOutputStream("descargas/permisos_todoterrenos/"+inputmatricula.getText()+"-"+fecha+".pdf");
					Document documento = new Document();
					PdfWriter.getInstance(documento, archivo);
					documento.open();
					Paragraph titulo = new Paragraph("NUEVO TODOTERRENO");
				...
				MenuTodoterrenoInsertado men = new MenuTodoterrenoInsertado();
				dispose();
				men.setVisible(true);
