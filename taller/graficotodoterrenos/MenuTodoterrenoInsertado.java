...
public class MenuTodoterrenoInsertado extends JFrame implements KeyListener, ActionListener{
	...
	public MenuTodoterrenoInsertado() {
		super("Taller"); //Nome
        ...
        String texto =  "<html><body><p align='center'>TODOTERRENO REGISTRADO CORRECTAMENTE</p><br>"
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("VOLVER")) {
			MenuFichaTodoterreno men = new MenuFichaTodoterreno();
			dispose();
			men.setVisible(true);
