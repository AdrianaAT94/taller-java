...
public class MenuListadoTodoterrenosPorMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoTodoterrenosPorMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE TODOTERRENOS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(tod.consultarporMatricula(MenuListadoTodoterrenosEscribirMatricula.input.getText()));
