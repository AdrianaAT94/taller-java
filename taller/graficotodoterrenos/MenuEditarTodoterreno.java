...
public class MenuEditarTodoterreno extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarTodoterreno(){
        ...
        smatricula = tod.getMatricula(MenuEditarTodoterrenoLista.id);
        smarca = tod.getMarca(MenuEditarTodoterrenoLista.id);
        smodelo = tod.getModelo(MenuEditarTodoterrenoLista.id);
        scombustible = tod.getCombustible(MenuEditarTodoterrenoLista.id);
        snPuertas = tod.getnPuertas(MenuEditarTodoterrenoLista.id);
        snRuedas = tod.getnRuedas(MenuEditarTodoterrenoLista.id);
        smaxVelocidad = tod.getMaxVelocidad(MenuEditarTodoterrenoLista.id);
        scapMotor = tod.getCapMotor(MenuEditarTodoterrenoLista.id);
        scapAlmacenamiento = tod.getCapAlmacenamiento(MenuEditarTodoterrenoLista.id);
        snPasajeros = tod.getnPasajeros(MenuEditarTodoterrenoLista.id);
        sABS = tod.isABS(MenuEditarTodoterrenoLista.id);
        sGPS = tod.isGPS(MenuEditarTodoterrenoLista.id);
        sairbags = tod.isAirbags(MenuEditarTodoterrenoLista.id);
        sclimatizacion = tod.isClimatizacion(MenuEditarTodoterrenoLista.id);
        sdescapotable = tod.isDescapotable(MenuEditarTodoterrenoLista.id);
        sduenho = tod.getIdcliente(MenuEditarTodoterrenoLista.id);
        smotivoVisita = tod.getMotivoVisita(MenuEditarTodoterrenoLista.id);
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR TODOTERRENO");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
	        ...
	        if (tod.editar(MenuEditarTodoterrenoLista.id, inputmarca.getText(), inputmodelo.getText(), inputmatricula.getText(), combus, inputnPuertas.getText(), inputnRuedas.getText(), inputmaxVelocidad.getText(), inputcapMotor.getText(), inputcapAlmacenamiento.getText(), inputnPasajeros.getText(), a, g, airb, clim, des, idcli, inputmotivoVisita.getText())) {
				MenuListadoTodoterrenos men = new MenuListadoTodoterrenos();
				dispose();
				men.setVisible(true);
				...
				MenuErrorRegistroTodoterreno men = new MenuErrorRegistroTodoterreno();
				men.setVisible(true);
				dispose();
