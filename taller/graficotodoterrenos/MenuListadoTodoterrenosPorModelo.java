...
public class MenuListadoTodoterrenosPorModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoTodoterrenosPorModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(tod.consultarporModelo(MenuListadoTodoterrenosEscribirModelo.input.getText()));
