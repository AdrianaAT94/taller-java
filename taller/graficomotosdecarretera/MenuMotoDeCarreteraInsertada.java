...
public class MenuMotoDeCarreteraInsertada extends JFrame implements KeyListener, ActionListener{
	...
	public MenuMotoDeCarreteraInsertada() {
		super("Taller"); //Nome
        ...
        String texto =  "<html><body><p align='center'>MOTO DE CARRETERA REGISTRADA CORRECTAMENTE</p><br>"
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("VOLVER")) {
			MenuFichaMotoDeCarretera men = new MenuFichaMotoDeCarretera();
			dispose();
			men.setVisible(true);
