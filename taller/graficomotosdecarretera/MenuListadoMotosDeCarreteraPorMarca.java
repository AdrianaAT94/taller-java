...
public class MenuListadoMotosDeCarreteraPorMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMotosDeCarreteraPorMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(car.consultarporMarca(MenuListadoMotosDeCarreteraEscribirMarca.input.getText()));
