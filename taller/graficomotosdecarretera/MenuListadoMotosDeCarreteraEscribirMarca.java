...
public class MenuListadoMotosDeCarreteraEscribirMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMotosDeCarreteraEscribirMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MARCA DE MOTOS DE CARRETERA");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoMotosDeCarreteraPorMarca men = new MenuListadoMotosDeCarreteraPorMarca();
			dispose();
			men.setVisible(true);
