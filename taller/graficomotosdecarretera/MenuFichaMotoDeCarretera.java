...
public class MenuFichaMotoDeCarretera extends JFrame implements KeyListener, ActionListener {
	...
	public MenuFichaMotoDeCarretera(){
		super("Taller"); //Nome
        ...
        setResizable(false); //Que non se poda ccariar o tamaanho da ventana
        ...
        fic = new Ficha();
        car = new Carretera();
        sfechaEntrada = car.getfechaAlta(car.getUltimoRegitro());
        scliente = car.getNombrecliente(car.getUltimoRegitro());
        svehiculo = car.getNombrevehiculo(car.getUltimoRegitro());
...
idvehi = car.getUltimoRegitro();
		
		if (car.getCombustible(idvehi).equals("diésel")){
			inputdescripcion.setText("Revisión del filtro de partículas");
			if (car.getNombretipovehiculo(idvehi).equals("carulancia") || car.getNombretipovehiculo(idvehi).equals("Bomberos") || car.getNombretipovehiculo(idvehi).equals("Policía")) {
				inputdescripcion.setText("Revisión del filtro de partículas, Revisión de la sirena");	
			}
		}
		else if (car.getnRuedas(idvehi).equals("2")) {
		...
		else if (car.getNombretipovehiculo(idvehi).equals("carulancia") || car.getNombretipovehiculo(idvehi).equals("Bomberos") || car.getNombretipovehiculo(idvehi).equals("Policía")) {
	...
	public void actionPerformed(ActionEvent e) {		
		...
		if (e.getActionCommand().equals("ENVIAR")) {
				...
				if (fic.editar(car.getUltimoRegitro(), inputdescripcion.getText(), sest, inputfechaSalida.getText(), inputmotivo.getText())) {
