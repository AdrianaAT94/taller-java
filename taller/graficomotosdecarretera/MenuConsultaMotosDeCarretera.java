...
public class MenuConsultaMotosDeCarretera extends JFrame implements KeyListener, ActionListener {
	...
	public MenuConsultaMotosDeCarretera(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("GESTIÓN DE MOTOS DE CARRETERA");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("POR MATRÍCULA")) {
			MenuListadoMotosDeCarreteraEscribirMatricula men = new MenuListadoMotosDeCarreteraEscribirMatricula();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MARCA")) {
			MenuListadoMotosDeCarreteraEscribirMarca men = new MenuListadoMotosDeCarreteraEscribirMarca();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MODELO")) {
			MenuListadoMotosDeCarreteraEscribirModelo men = new MenuListadoMotosDeCarreteraEscribirModelo();
			dispose(); //elimina ventana
			men.setVisible(true);
