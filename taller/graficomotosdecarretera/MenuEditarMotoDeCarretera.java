...
public class MenuEditarMotoDeCarretera extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarMotoDeCarretera(){
		super("Taller"); //Nome
        ...
        smatricula = car.getMatricula(MenuEditarMotosDeCarreteraLista.id);
        smarca = car.getMarca(MenuEditarMotosDeCarreteraLista.id);
        smodelo = car.getModelo(MenuEditarMotosDeCarreteraLista.id);
        scombustible = car.getCombustible(MenuEditarMotosDeCarreteraLista.id);
        snPuertas = car.getnPuertas(MenuEditarMotosDeCarreteraLista.id);
        snRuedas = car.getnRuedas(MenuEditarMotosDeCarreteraLista.id);
        smaxVelocidad = car.getMaxVelocidad(MenuEditarMotosDeCarreteraLista.id);
        scapMotor = car.getCapMotor(MenuEditarMotosDeCarreteraLista.id);
        scapAlmacenamiento = car.getCapAlmacenamiento(MenuEditarMotosDeCarreteraLista.id);
        snPasajeros = car.getnPasajeros(MenuEditarMotosDeCarreteraLista.id);
        sABS = car.isABS(MenuEditarMotosDeCarreteraLista.id);
        sGPS = car.isGPS(MenuEditarMotosDeCarreteraLista.id);
        sairbags = car.isAirbags(MenuEditarMotosDeCarreteraLista.id);
        sclimatizacion = car.isClimatizacion(MenuEditarMotosDeCarreteraLista.id);
        sdescapotable = car.isDescapotable(MenuEditarMotosDeCarreteraLista.id);
        sduenho = car.getIdcliente(MenuEditarMotosDeCarreteraLista.id);
        smotivoVisita = car.getMotivoVisita(MenuEditarMotosDeCarreteraLista.id);
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR MOTO DE CARRETERA");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
	        ...
	        if (car.editar(MenuEditarMotosDeCarreteraLista.id, inputmarca.getText(), inputmodelo.getText(), inputmatricula.getText(), combus, inputnPuertas.getText(), inputnRuedas.getText(), inputmaxVelocidad.getText(), inputcapMotor.getText(), inputcapAlmacenamiento.getText(), inputnPasajeros.getText(), a, g, airb, clim, des, idcli, inputmotivoVisita.getText())) {
				MenuListadoMotosDeCarretera men = new MenuListadoMotosDeCarretera();
				dispose();
				men.setVisible(true);
