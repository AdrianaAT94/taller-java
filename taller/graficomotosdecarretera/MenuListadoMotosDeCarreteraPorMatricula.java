...
public class MenuListadoMotosDeCarreteraPorMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMotosDeCarreteraPorMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE MOTOS DE CARRETERA");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(car.consultarporMatricula(MenuListadoMotosDeCarreteraEscribirMatricula.input.getText()));
