...
public class MenuListadoMotosDeCarreteraEscribirMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMotosDeCarreteraEscribirMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MATRÍCULA DE MOTOS DE CARRETERA");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuConsultaMotosDeCarretera men = new MenuConsultaMotosDeCarretera();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoMotosDeCarreteraPorMatricula men = new MenuListadoMotosDeCarreteraPorMatricula();
			dispose();
			men.setVisible(true);
