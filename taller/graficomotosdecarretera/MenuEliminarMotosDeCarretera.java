...
public class MenuEliminarMotosDeCarretera extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEliminarMotosDeCarretera(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("ELIMINAR MOTOS DE CARRETERA");
