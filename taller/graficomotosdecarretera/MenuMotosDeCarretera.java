...
public class MenuMotosDeCarretera extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVA")) {
			MenuNuevaMotoDeCarretera con = new MenuNuevaMotoDeCarretera();
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaMotosDeCarretera con = new MenuConsultaMotosDeCarretera();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarMotosDeCarreteraLista con = new MenuEditarMotosDeCarreteraLista();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarMotosDeCarretera con = new MenuEliminarMotosDeCarretera();
			dispose(); //elimina ventana
			con.setVisible(true);
