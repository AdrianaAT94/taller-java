...
public class MenuEditarMotosDeCarreteraLista extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarMotosDeCarreteraLista(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR MOTOS DE CARRETERA");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Qué moto de carretera quieres editar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("EDITAR")) {
			...
			MenuEditarMotoDeCarretera men = new MenuEditarMotoDeCarretera();
			dispose();
			men.setVisible(true);
