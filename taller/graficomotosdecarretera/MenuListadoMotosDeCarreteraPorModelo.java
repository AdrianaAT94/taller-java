...
public class MenuListadoMotosDeCarreteraPorModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMotosDeCarreteraPorModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(car.consultarporModelo(MenuListadoMotosDeCarreteraEscribirModelo.input.getText()));
