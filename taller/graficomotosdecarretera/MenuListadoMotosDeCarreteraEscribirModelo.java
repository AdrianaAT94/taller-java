...
public class MenuListadoMotosDeCarreteraEscribirModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMotosDeCarreteraEscribirModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MODELO DE MOTOS DE CARRETERA");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoMotosDeCarreteraPorModelo men = new MenuListadoMotosDeCarreteraPorModelo();
			dispose();
			men.setVisible(true);
