...
public class MenuListadoCochesBomberosEscribirMarca extends JFrame implements KeyListener, ActionListener {

	//Botons menu
	Boton atras, enviar;
	Font fuente;
	JPanel panel, panel2, panel3;
	JLabel label, label2, marca;
	static JTextField input;
	Vehiculo bom;
	
	public MenuListadoCochesBomberosEscribirMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MARCA DE COCHES DE BOMBEROS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Que marca quieres buscar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoCochesBomberosPorMarca men = new MenuListadoCochesBomberosPorMarca();
			dispose();
			men.setVisible(true);
