...
public class MenuEliminarCocheBombero extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEliminarCocheBombero(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("ELIMINAR COCHE DE BOMBEROS");
