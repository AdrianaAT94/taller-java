...
public class MenuCocheBomberoInsertado extends JFrame implements KeyListener, ActionListener{
	...
	public MenuCocheBomberoInsertado() {
		super("Taller"); //Nome
        ...
        String texto =  "<html><body><p align='center'>COCHE DE BOMBEROS REGISTRADO CORRECTAMENTE</p><br>"
        		+ "<p align='center'>Se ha descargado un archivo PDF con todos los datos.</p><p></p>"
        		+ "<p align='center'>Ahora se proceder� a registrar la ficha<br> tras el previo consentimiento del cliente.</p></body></html>" ;
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("VOLVER")) {
			MenuFichaCocheBombero men = new MenuFichaCocheBombero();
			dispose();
			men.setVisible(true);
