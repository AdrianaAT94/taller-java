...
public class MenuConsultaCochesBomberos extends JFrame implements KeyListener, ActionListener {
	...
	public MenuConsultaCochesBomberos(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("GESTIÓN DE COCHES DE BOMBEROS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("POR MATRÍCULA")) {
			MenuListadoCochesBomberosEscribirMatricula men = new MenuListadoCochesBomberosEscribirMatricula();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MARCA")) {
			MenuListadoCochesBomberosEscribirMarca men = new MenuListadoCochesBomberosEscribirMarca();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MODELO")) {
			MenuListadoCochesBomberosEscribirModelo men = new MenuListadoCochesBomberosEscribirModelo();
			dispose(); //elimina ventana
			men.setVisible(true);
