...
public class MenuListadoCochesBomberosPorMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCochesBomberosPorMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE COCHES DE BOMBEROS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(bom.consultarporMatricula(MenuListadoCochesBomberosEscribirMatricula.input.getText()));
