...
public class MenuListadoCochesBomberosEscribirModelo extends JFrame implements KeyListener, ActionListener {

	//Botons menu
	Boton atras, enviar;
	Font fuente;
	JPanel panel, panel2, panel3;
	JLabel label, label2, modelo;
	static JTextField input;
	Vehiculo bom;
	
	public MenuListadoCochesBomberosEscribirModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MODELO DE COCHES DE BOMBEROS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Que modelo quieres buscar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoCochesBomberosPorModelo men = new MenuListadoCochesBomberosPorModelo();
			dispose();
			men.setVisible(true);
