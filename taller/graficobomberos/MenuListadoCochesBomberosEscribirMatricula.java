...
public class MenuListadoCochesBomberosEscribirMatricula extends JFrame implements KeyListener, ActionListener {

	//Botons menu
	Boton atras, enviar;
	Font fuente;
	JPanel panel, panel2, panel3;
	JLabel label, label2, matricula;
	static JTextField input;
	Vehiculo bom;
	
	public MenuListadoCochesBomberosEscribirMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MATRÍCULA DE COCHES DE BOMBEROS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Que matrícula quieres buscar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuConsultaCochesBomberos men = new MenuConsultaCochesBomberos();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoCochesBomberosPorMatricula men = new MenuListadoCochesBomberosPorMatricula();
			dispose();
			men.setVisible(true);
