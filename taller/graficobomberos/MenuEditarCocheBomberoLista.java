...
public class MenuEditarCocheBomberoLista extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarCocheBomberoLista(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR COCHE DE BOMBEROS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Qué coche de bomberos quieres editar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("EDITAR")) {
			...
			MenuEditarCocheBombero men = new MenuEditarCocheBombero();
			dispose();
			men.setVisible(true);
