...
public class MenuListadoCochesBomberosPorModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCochesBomberosPorModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE COCHES DE BOMBERO");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(bom.consultarporModelo(MenuListadoCochesBomberosEscribirModelo.input.getText()));
