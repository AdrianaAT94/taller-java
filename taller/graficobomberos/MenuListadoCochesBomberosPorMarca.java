...
public class MenuListadoCochesBomberosPorMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCochesBomberosPorMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(bom.consultarporMarca(MenuListadoCochesBomberosEscribirMarca.input.getText()));
