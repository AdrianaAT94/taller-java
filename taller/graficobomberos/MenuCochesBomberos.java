...
public class MenuCochesBomberos extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVO")) {
			MenuNuevoCocheBomberos con = new MenuNuevoCocheBomberos();
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaCochesBomberos con = new MenuConsultaCochesBomberos();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarCocheBomberoLista con = new MenuEditarCocheBomberoLista();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarCocheBombero con = new MenuEliminarCocheBombero();
			dispose(); //elimina ventana
			con.setVisible(true);
