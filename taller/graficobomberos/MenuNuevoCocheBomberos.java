...
import graficoprincipal.MenuVehiculos;
...
public class MenuNuevoCocheBomberos extends JFrame implements KeyListener, ActionListener {
	...
	public MenuNuevoCocheBomberos(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("REGISTRO DE NUEVO COCHE DE BOMBEROS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			...
			if (bom.insertar(inputmarca.getText(), inputmodelo.getText(), inputmatricula.getText(), combus, inputnPuertas.getText(), inputnRuedas.getText(), inputmaxVelocidad.getText(), inputcapMotor.getText(), inputcapAlmacenamiento.getText(), inputnPasajeros.getText(), a, g, airb, clim, des, id, inputmotivoVisita.getText())) {
				...
				try {
					archivo = new FileOutputStream("descargas/permisos_cochesdebomberos/"+inputmatricula.getText()+"-"+fecha+".pdf");
					Document documento = new Document();
					PdfWriter.getInstance(documento, archivo);
					documento.open();
					Paragraph titulo = new Paragraph("NUEVO COCHE DE BOMBEROS");
				...
				MenuCocheBomberoInsertado men = new MenuCocheBomberoInsertado();
				dispose();
				men.setVisible(true);
