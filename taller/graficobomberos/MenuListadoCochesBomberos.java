...
public class MenuListadoCochesBomberos extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCochesBomberos(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE CAMIONES DE BOMBEROS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(bom.listar());
