...
public class MenuConsultaFurgonetas extends JFrame implements KeyListener, ActionListener {
	...
	public MenuConsultaFurgonetas(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("GESTIÓN DE FURGONETAS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("POR MATRÍCULA")) {
			MenuListadoFurgonetasEscribirMatricula men = new MenuListadoFurgonetasEscribirMatricula();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MARCA")) {
			MenuListadoFurgonetasEscribirMarca men = new MenuListadoFurgonetasEscribirMarca();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MODELO")) {
			MenuListadoFurgonetasEscribirModelo men = new MenuListadoFurgonetasEscribirModelo();
			dispose(); //elimina ventana
			men.setVisible(true);
