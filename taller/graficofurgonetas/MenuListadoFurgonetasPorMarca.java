...
public class MenuListadoFurgonetasPorMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoFurgonetasPorMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(fur.consultarporMarca(MenuListadoFurgonetasEscribirMarca.input.getText()));
