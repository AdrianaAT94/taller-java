...
public class MenuEditarFurgoneta extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarFurgoneta(){
        ...
        smatricula = fur.getMatricula(MenuEditarFurgonetaLista.id);
        smarca = fur.getMarca(MenuEditarFurgonetaLista.id);
        smodelo = fur.getModelo(MenuEditarFurgonetaLista.id);
        scombustible = fur.getCombustible(MenuEditarFurgonetaLista.id);
        snPuertas = fur.getnPuertas(MenuEditarFurgonetaLista.id);
        snRuedas = fur.getnRuedas(MenuEditarFurgonetaLista.id);
        smaxVelocidad = fur.getMaxVelocidad(MenuEditarFurgonetaLista.id);
        scapMotor = fur.getCapMotor(MenuEditarFurgonetaLista.id);
        scapAlmacenamiento = fur.getCapAlmacenamiento(MenuEditarFurgonetaLista.id);
        snPasajeros = fur.getnPasajeros(MenuEditarFurgonetaLista.id);
        sABS = fur.isABS(MenuEditarFurgonetaLista.id);
        sGPS = fur.isGPS(MenuEditarFurgonetaLista.id);
        sairbags = fur.isAirbags(MenuEditarFurgonetaLista.id);
        sclimatizacion = fur.isClimatizacion(MenuEditarFurgonetaLista.id);
        sdescapotable = fur.isDescapotable(MenuEditarFurgonetaLista.id);
        sduenho = fur.getIdcliente(MenuEditarFurgonetaLista.id);
        smotivoVisita = fur.getMotivoVisita(MenuEditarFurgonetaLista.id);
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR FURGONETA");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuFurgonetas men = new MenuFurgonetas();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
	        ...
	        if (fur.editar(MenuEditarFurgonetaLista.id, inputmarca.getText(), inputmodelo.getText(), inputmatricula.getText(), combus, inputnPuertas.getText(), inputnRuedas.getText(), inputmaxVelocidad.getText(), inputcapMotor.getText(), inputcapAlmacenamiento.getText(), inputnPasajeros.getText(), a, g, airb, clim, des, idcli, inputmotivoVisita.getText())) {
				MenuListadoFurgonetas men = new MenuListadoFurgonetas();
				dispose();
				men.setVisible(true);
				...
				MenuErrorRegistroFurgoneta men = new MenuErrorRegistroFurgoneta();
				men.setVisible(true);
				dispose();
