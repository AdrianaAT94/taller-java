...
public class MenuEditarFurgonetaLista extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarFurgonetaLista(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label2 = new JLabel("¿Qué furgoneta quieres editar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("EDITAR")) {
			...
			MenuEditarFurgoneta men = new MenuEditarFurgoneta();
			dispose();
			men.setVisible(true);
