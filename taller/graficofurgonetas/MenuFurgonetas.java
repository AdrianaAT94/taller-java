...
public class MenuFurgonetas extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVA")) {
			MenuNuevaFurgoneta con = new MenuNuevaFurgoneta();
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaFurgonetas con = new MenuConsultaFurgonetas();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarFurgonetaLista con = new MenuEditarFurgonetaLista();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarFurgoneta con = new MenuEliminarFurgoneta();
			dispose(); //elimina ventana
			con.setVisible(true);
