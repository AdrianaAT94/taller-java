...
public class MenuFurgonetaInsertada extends JFrame implements KeyListener, ActionListener{
	...
	public MenuFurgonetaInsertada() {
        ...
        String texto =  "<html><body><p align='center'>FURGONETA REGISTRADA CORRECTAMENTE</p><br>"
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("VOLVER")) {
			MenuFichaFurgoneta men = new MenuFichaFurgoneta();
			dispose();
			men.setVisible(true);
