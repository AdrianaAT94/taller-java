...
public class MenuListadoFurgonetasEscribirMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoFurgonetasEscribirMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MARCA DE FURGONETAS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoFurgonetasPorMarca men = new MenuListadoFurgonetasPorMarca();
			dispose();
			men.setVisible(true);
