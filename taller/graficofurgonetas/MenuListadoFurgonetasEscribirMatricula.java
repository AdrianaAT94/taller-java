...
public class MenuListadoFurgonetasEscribirMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoFurgonetasEscribirMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MATRÍCULA DE FURGONETAS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuConsultaFurgonetas men = new MenuConsultaFurgonetas();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoFurgonetasPorMatricula men = new MenuListadoFurgonetasPorMatricula();
			dispose();
			men.setVisible(true);
