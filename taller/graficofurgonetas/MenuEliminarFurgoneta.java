...
public class MenuEliminarFurgoneta extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEliminarFurgoneta(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("ELIMINAR FURGONETAS");
