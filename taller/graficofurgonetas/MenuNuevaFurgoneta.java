...
public class MenuNuevaFurgoneta extends JFrame implements KeyListener, ActionListener {
	...
	public MenuNuevaFurgoneta(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("REGISTRO DE NUEVA FURGONETA");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			...
			if (fur.insertar(inputmarca.getText(), inputmodelo.getText(), inputmatricula.getText(), combus, inputnPuertas.getText(), inputnRuedas.getText(), inputmaxVelocidad.getText(), inputcapMotor.getText(), inputcapAlmacenamiento.getText(), inputnPasajeros.getText(), a, g, airb, clim, des, id, inputmotivoVisita.getText())) {
				...
				try {
					archivo = new FileOutputStream("descargas/permisos_furgonetas/"+inputmatricula.getText()+"-"+fecha+".pdf");
					Document documento = new Document();
					PdfWriter.getInstance(documento, archivo);
					documento.open();
					Paragraph titulo = new Paragraph("NUEVA FURGONETA");
				...
				MenuFurgonetaInsertada men = new MenuFurgonetaInsertada();
				dispose();
				men.setVisible(true);
