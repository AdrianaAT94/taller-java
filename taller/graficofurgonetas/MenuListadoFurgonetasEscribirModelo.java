...
public class MenuListadoFurgonetasEscribirModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoFurgonetasEscribirModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MODELO DE FURGONETAS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoFurgonetasPorModelo men = new MenuListadoFurgonetasPorModelo();
			dispose();
			men.setVisible(true);
