...
public class MenuListadoFurgonetasPorModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoFurgonetasPorModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(fur.consultarporModelo(MenuListadoFurgonetasEscribirModelo.input.getText()));
