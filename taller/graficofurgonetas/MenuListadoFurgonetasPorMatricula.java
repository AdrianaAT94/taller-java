...
public class MenuListadoFurgonetasPorMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoFurgonetasPorMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE FURGONETAS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(fur.consultarporMatricula(MenuListadoFurgonetasEscribirMatricula.input.getText()));
