...
public class MenuListadoCamionesPorMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCamionesPorMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(cam.consultarporMarca(MenuListadoCamionesEscribirMarca.input.getText()));
