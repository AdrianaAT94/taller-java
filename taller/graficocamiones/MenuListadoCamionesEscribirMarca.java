...
public class MenuListadoCamionesEscribirMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCamionesEscribirMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MARCA DE CAMIONES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoCamionesPorMarca men = new MenuListadoCamionesPorMarca();
			dispose();
			men.setVisible(true);
