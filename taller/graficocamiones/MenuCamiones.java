...
public class MenuCamiones extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVO")) {
			MenuNuevoCamion con = new MenuNuevoCamion();
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaCamiones con = new MenuConsultaCamiones();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarCamionLista con = new MenuEditarCamionLista();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarCamion con = new MenuEliminarCamion();
			dispose(); //elimina ventana
			con.setVisible(true);
