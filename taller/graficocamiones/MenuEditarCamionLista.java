...
public class MenuEditarCamionLista extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarCamionLista(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR CAMIONES");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Qué camión quieres editar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("EDITAR")) {
			...
			MenuEditarCamion men = new MenuEditarCamion();
			dispose();
			men.setVisible(true);
