...
public class MenuListadoCamionesPorModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCamionesPorModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(cam.consultarporModelo(MenuListadoCamionesEscribirModelo.input.getText()));
