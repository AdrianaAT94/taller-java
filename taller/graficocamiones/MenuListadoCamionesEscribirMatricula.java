...
public class MenuListadoCamionesEscribirMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCamionesEscribirMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MATRÍCULA DE CAMIONES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuConsultaCamiones men = new MenuConsultaCamiones();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoCamionesPorMatricula men = new MenuListadoCamionesPorMatricula();
			dispose();
			men.setVisible(true);
