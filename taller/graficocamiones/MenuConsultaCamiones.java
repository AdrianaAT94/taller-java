...
public class MenuConsultaCamiones extends JFrame implements KeyListener, ActionListener {
	...
	public MenuConsultaCamiones(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("GESTIÓN DE CAMIONES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("POR MATRÍCULA")) {
			MenuListadoCamionesEscribirMatricula men = new MenuListadoCamionesEscribirMatricula();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MARCA")) {
			MenuListadoCamionesEscribirMarca men = new MenuListadoCamionesEscribirMarca();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MODELO")) {
			MenuListadoCamionesEscribirModelo men = new MenuListadoCamionesEscribirModelo();
			dispose(); //elimina ventana
			men.setVisible(true);
