...
public class MenuListadoCamionesEscribirModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCamionesEscribirModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MODELO DE CAMIONES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoCamionesPorModelo men = new MenuListadoCamionesPorModelo();
			dispose();
			men.setVisible(true);
