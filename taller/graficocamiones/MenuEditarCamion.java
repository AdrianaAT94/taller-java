...
public class MenuEditarCamion extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarCamion(){
        ...
        smatricula = cam.getMatricula(MenuEditarCamionLista.id);
        smarca = cam.getMarca(MenuEditarCamionLista.id);
        smodelo = cam.getModelo(MenuEditarCamionLista.id);
        scombustible = cam.getCombustible(MenuEditarCamionLista.id);
        snPuertas = cam.getnPuertas(MenuEditarCamionLista.id);
        snRuedas = cam.getnRuedas(MenuEditarCamionLista.id);
        smaxVelocidad = cam.getMaxVelocidad(MenuEditarCamionLista.id);
        scapMotor = cam.getCapMotor(MenuEditarCamionLista.id);
        scapAlmacenamiento = cam.getCapAlmacenamiento(MenuEditarCamionLista.id);
        snPasajeros = cam.getnPasajeros(MenuEditarCamionLista.id);
        sABS = cam.isABS(MenuEditarCamionLista.id);
        sGPS = cam.isGPS(MenuEditarCamionLista.id);
        sairbags = cam.isAirbags(MenuEditarCamionLista.id);
        sclimatizacion = cam.isClimatizacion(MenuEditarCamionLista.id);
        sdescapotable = cam.isDescapotable(MenuEditarCamionLista.id);
        sduenho = cam.getIdcliente(MenuEditarCamionLista.id);
        smotivoVisita = cam.getMotivoVisita(MenuEditarCamionLista.id);
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR CAMIÓN");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuCamiones men = new MenuCamiones();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
	        ...
	        if (cam.editar(MenuEditarCamionLista.id, inputmarca.getText(), inputmodelo.getText(), inputmatricula.getText(), combus, inputnPuertas.getText(), inputnRuedas.getText(), inputmaxVelocidad.getText(), inputcapMotor.getText(), inputcapAlmacenamiento.getText(), inputnPasajeros.getText(), a, g, airb, clim, des, idcli, inputmotivoVisita.getText())) {
				MenuListadoCamiones men = new MenuListadoCamiones();
				dispose();
				men.setVisible(true);
				...
				MenuErrorRegistroCamion men = new MenuErrorRegistroCamion();
				men.setVisible(true);
				dispose();
