...
public class MenuCamionInsertado extends JFrame implements KeyListener, ActionListener{
	...
	public MenuCamionInsertado() {
        ...
        String texto =  "<html><body><p align='center'>CAMI”N REGISTRADO CORRECTAMENTE</p><br>"
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("VOLVER")) {
			MenuFichaCamion men = new MenuFichaCamion();
			dispose();
			men.setVisible(true);
