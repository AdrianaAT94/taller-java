...
public class MenuListadoCamionesPorMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoCamionesPorMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE CAMIONES");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(cam.consultarporMatricula(MenuListadoCamionesEscribirMatricula.input.getText()));
