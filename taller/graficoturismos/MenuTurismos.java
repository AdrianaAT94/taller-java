...
public class MenuTurismos extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVO")) {
			MenuNuevoTurismo con = new MenuNuevoTurismo();
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaTurismos con = new MenuConsultaTurismos();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarTurismoLista con = new MenuEditarTurismoLista();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarTurismo con = new MenuEliminarTurismo();
			dispose(); //elimina ventana
			con.setVisible(true);
