...
public class MenuConsultaTurismos extends JFrame implements KeyListener, ActionListener {
	...
	public MenuConsultaTurismos(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("GESTIÓN DE TURISMOS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("POR MATRÍCULA")) {
			MenuListadoTurismosEscribirMatricula men = new MenuListadoTurismosEscribirMatricula();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MARCA")) {
			MenuListadoTurismosEscribirMarca men = new MenuListadoTurismosEscribirMarca();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MODELO")) {
			MenuListadoTurismosEscribirModelo men = new MenuListadoTurismosEscribirModelo();
			dispose(); //elimina ventana
			men.setVisible(true);
