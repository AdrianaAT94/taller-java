...
public class MenuFichaTurismo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuFichaTurismo(){
        ...
        setResizable(false); //Que non se poda cturiar o tamaanho da ventana
        ...
        fic = new Ficha();
        tur = new Turismo();
        sfechaEntrada = tur.getfechaAlta(tur.getUltimoRegitro());
        scliente = tur.getNombrecliente(tur.getUltimoRegitro());
        svehiculo = tur.getNombrevehiculo(tur.getUltimoRegitro());
...
idvehi = tur.getUltimoRegitro();
		
		if (tur.getCombustible(idvehi).equals("diésel")){
			inputdescripcion.setText("Revisión del filtro de partículas");
			if (tur.getNombretipovehiculo(idvehi).equals("turulancia") || tur.getNombretipovehiculo(idvehi).equals("Bomberos") || tur.getNombretipovehiculo(idvehi).equals("Policía")) {
				inputdescripcion.setText("Revisión del filtro de partículas, Revisión de la sirena");	
			}
		}
		else if (tur.getnRuedas(idvehi).equals("2")) {
		...
		else if (tur.getNombretipovehiculo(idvehi).equals("turulancia") || tur.getNombretipovehiculo(idvehi).equals("Bomberos") || tur.getNombretipovehiculo(idvehi).equals("Policía")) {
	...
	public void actionPerformed(ActionEvent e) {		
		...
		if (e.getActionCommand().equals("ENVIAR")) {
				...
				if (fic.editar(tur.getUltimoRegitro(), inputdescripcion.getText(), sest, inputfechaSalida.getText(), inputmotivo.getText())) {
