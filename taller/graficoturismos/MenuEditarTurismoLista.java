...
public class MenuEditarTurismoLista extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarTurismoLista(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR TURISMOS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Qué turismo quieres editar?");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("EDITAR")) {
			...
			MenuEditarTurismo men = new MenuEditarTurismo();
			dispose();
			men.setVisible(true);
