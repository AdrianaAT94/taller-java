...
public class MenuListadoTurismosPorModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoTurismosPorModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(tur.consultarporModelo(MenuListadoTurismosEscribirModelo.input.getText()));
