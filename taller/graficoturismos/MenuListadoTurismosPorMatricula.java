...
public class MenuListadoTurismosPorMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoTurismosPorMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE TURISMOS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(tur.consultarporMatricula(MenuListadoTurismosEscribirMatricula.input.getText()));
