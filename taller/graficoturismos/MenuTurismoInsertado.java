...
public class MenuTurismoInsertado extends JFrame implements KeyListener, ActionListener{
	...
	public MenuTurismoInsertado() {
        ...
        String texto =  "<html><body><p align='center'>TURISMO REGISTRADO CORRECTAMENTE</p><br>"
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("VOLVER")) {
			MenuFichaTurismo men = new MenuFichaTurismo();
			dispose();
			men.setVisible(true);
