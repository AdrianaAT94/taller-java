...
public class MenuListadoTurismosPorMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoTurismosPorMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(tur.consultarporMarca(MenuListadoTurismosEscribirMarca.input.getText()));
