...
public class MenuEliminarTurismo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEliminarTurismo(){
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("ELIMINAR TURISMO");
