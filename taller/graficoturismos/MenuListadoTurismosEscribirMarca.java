...
public class MenuListadoTurismosEscribirMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoTurismosEscribirMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MARCA DE TURISMOS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoTurismosPorMarca men = new MenuListadoTurismosPorMarca();
			dispose();
			men.setVisible(true);
