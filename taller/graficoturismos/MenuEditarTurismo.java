...
public class MenuEditarTurismo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarTurismo(){
        ...
        smatricula = tur.getMatricula(MenuEditarTurismoLista.id);
        smarca = tur.getMarca(MenuEditarTurismoLista.id);
        smodelo = tur.getModelo(MenuEditarTurismoLista.id);
        scombustible = tur.getCombustible(MenuEditarTurismoLista.id);
        snPuertas = tur.getnPuertas(MenuEditarTurismoLista.id);
        snRuedas = tur.getnRuedas(MenuEditarTurismoLista.id);
        smaxVelocidad = tur.getMaxVelocidad(MenuEditarTurismoLista.id);
        scapMotor = tur.getCapMotor(MenuEditarTurismoLista.id);
        scapAlmacenamiento = tur.getCapAlmacenamiento(MenuEditarTurismoLista.id);
        snPasajeros = tur.getnPasajeros(MenuEditarTurismoLista.id);
        sABS = tur.isABS(MenuEditarTurismoLista.id);
        sGPS = tur.isGPS(MenuEditarTurismoLista.id);
        sairbags = tur.isAirbags(MenuEditarTurismoLista.id);
        sclimatizacion = tur.isClimatizacion(MenuEditarTurismoLista.id);
        sdescapotable = tur.isDescapotable(MenuEditarTurismoLista.id);
        sduenho = tur.getIdcliente(MenuEditarTurismoLista.id);
        smotivoVisita = tur.getMotivoVisita(MenuEditarTurismoLista.id);
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR TURISMO");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuTurismos men = new MenuTurismos();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
	        ...
	        if (tur.editar(MenuEditarTurismoLista.id, inputmarca.getText(), inputmodelo.getText(), inputmatricula.getText(), combus, inputnPuertas.getText(), inputnRuedas.getText(), inputmaxVelocidad.getText(), inputcapMotor.getText(), inputcapAlmacenamiento.getText(), inputnPasajeros.getText(), a, g, airb, clim, des, idcli, inputmotivoVisita.getText())) {
				MenuListadoTurismos men = new MenuListadoTurismos();
				dispose();
				men.setVisible(true);
				...
				MenuErrorRegistroTurismo men = new MenuErrorRegistroTurismo();
				men.setVisible(true);
				dispose();
