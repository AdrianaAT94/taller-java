...
public class MenuListadoTurismosEscribirMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoTurismosEscribirMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MATRÍCULA DE TURISMOS");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuConsultaTurismos men = new MenuConsultaTurismos();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoTurismosPorMatricula men = new MenuListadoTurismosPorMatricula();
			dispose();
			men.setVisible(true);
