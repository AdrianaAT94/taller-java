...
public class MenuListadoFichasPorCliente extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoFichasPorCliente(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(fic.consultarporCliente(MenuListadoFichasEscribirCliente.input.getText(), MenuListadoFichasEscribirCliente.inputfechaEntrada1.getText(), MenuListadoFichasEscribirCliente.inputfechaEntrada2.getText()));
