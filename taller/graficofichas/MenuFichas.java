...
public class MenuFichas extends JFrame implements KeyListener, ActionListener {

	//Botons menu
	Boton nueva, consulta, editar, eliminar, atras;
	Font fuente;
	JPanel panel;
	JLabel label;
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVA")) {
			MenuNuevaFicha con = new MenuNuevaFicha();
			dispose();
			con.setVisible(true);
			
			//para desactivar o espacio no control de menu
			JPanel panel = (JPanel) con.getContentPane();
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaFichas con = new MenuConsultaFichas();
			dispose();
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarFichaLista con = new MenuEditarFichaLista();
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarFicha con = new MenuEliminarFicha();
			dispose(); //elimina ventana
			con.setVisible(true);
