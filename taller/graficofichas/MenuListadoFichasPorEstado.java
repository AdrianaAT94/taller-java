...
public class MenuListadoFichasPorEstado extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoFichasPorEstado(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE FICHAS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(fic.consultarporEstado(MenuListadoFichasSeleccionarEstado.sel.getSelectedItem().toString(), MenuListadoFichasSeleccionarEstado.inputfechaEntrada1.getText(), MenuListadoFichasSeleccionarEstado.inputfechaEntrada2.getText()));
