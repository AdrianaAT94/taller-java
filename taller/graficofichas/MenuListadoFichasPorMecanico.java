...
public class MenuListadoFichasPorMecanico extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoFichasPorMecanico(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(fic.consultarporMecanico(MenuListadoFichasEscribirMecanico.input.getText(), MenuListadoFichasEscribirMecanico.inputfechaEntrada1.getText(), MenuListadoFichasEscribirMecanico.inputfechaEntrada2.getText()));
