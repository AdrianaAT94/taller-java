...
public class MenuListadoFichasEscribirMecanico extends JFrame implements KeyListener, ActionListener {

	//Botons menu
	Boton atras, enviar;
	Font fuente;
	JPanel panel, panel2, panel3, panel4;
	JLabel label, label2, mecanico, fechaEntrada1, fechaEntrada2;
	static JTextField input, inputfechaEntrada1, inputfechaEntrada2;
	Ficha fic;
	
	public MenuListadoFichasEscribirMecanico(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        mecanico = new JLabel("Nombre Mecánico: ");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoFichasPorMecanico men = new MenuListadoFichasPorMecanico();
			dispose();
			men.setVisible(true);
