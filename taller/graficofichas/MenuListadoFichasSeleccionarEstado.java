...
public class MenuListadoFichasSeleccionarEstado extends JFrame implements KeyListener, ActionListener {

	//Botons menu
	Boton atras, enviar;
	Font fuente;
	JPanel panel, panel2, panel3, panel4;
	JLabel label, label2, estado, fechaEntrada1, fechaEntrada2;
	static JComboBox sel;
	static JTextField inputfechaEntrada1, inputfechaEntrada2;
	Ficha fic;
	
	public MenuListadoFichasSeleccionarEstado(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR ESTADO DE FICHAS");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        label2 = new JLabel("¿Que estado quieres buscar?");
        ...
        sel = new JComboBox();
        sel.addItem("pendiente");
        sel.addItem("en proceso");
        sel.addItem("parado");
        sel.addItem("fase prueba");
        sel.addItem("terminado");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoFichasPorEstado men = new MenuListadoFichasPorEstado();
			dispose();
			men.setVisible(true);
