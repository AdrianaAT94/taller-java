...
public class MenuListadoMonovolumenesEscribirMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMonovolumenesEscribirMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MATRÍCULA DE MONOVOLÚMENES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ATRÁS")) {
			MenuConsultaMonovolumenes men = new MenuConsultaMonovolumenes();
			dispose();
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoMonovolumenesPorMatricula men = new MenuListadoMonovolumenesPorMatricula();
			dispose();
			men.setVisible(true);
