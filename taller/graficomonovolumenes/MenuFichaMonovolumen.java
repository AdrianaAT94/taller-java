...
public class MenuFichaMonovolumen extends JFrame implements KeyListener, ActionListener {
	...
	public MenuFichaMonovolumen(){
        ...
        setResizable(false); //Que non se poda cmoniar o tamaanho da ventana
        ...
        fic = new Ficha();
        mon = new Monovolumen();
        sfechaEntrada = mon.getfechaAlta(mon.getUltimoRegitro());
        scliente = mon.getNombrecliente(mon.getUltimoRegitro());
        svehiculo = mon.getNombrevehiculo(mon.getUltimoRegitro());
...
idvehi = mon.getUltimoRegitro();
		
		if (mon.getCombustible(idvehi).equals("diésel")){
			inputdescripcion.setText("Revisión del filtro de partículas");
			if (mon.getNombretipovehiculo(idvehi).equals("monulancia") || mon.getNombretipovehiculo(idvehi).equals("Bomberos") || mon.getNombretipovehiculo(idvehi).equals("Policía")) {
				inputdescripcion.setText("Revisión del filtro de partículas, Revisión de la sirena");	
			}
		}
		else if (mon.getnRuedas(idvehi).equals("2")) {
		...
		else if (mon.getNombretipovehiculo(idvehi).equals("monulancia") || mon.getNombretipovehiculo(idvehi).equals("Bomberos") || mon.getNombretipovehiculo(idvehi).equals("Policía")) {
	...
	public void actionPerformed(ActionEvent e) {		
		...
		if (e.getActionCommand().equals("ENVIAR")) {
				...
				if (fic.editar(mon.getUltimoRegitro(), inputdescripcion.getText(), sest, inputfechaSalida.getText(), inputmotivo.getText())) {
