...
public class MenuEditarMonovolumen extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEditarMonovolumen(){
        ...
        smatricula = mon.getMatricula(MenuEditarMonovolumenLista.id);
        smarca = mon.getMarca(MenuEditarMonovolumenLista.id);
        smodelo = mon.getModelo(MenuEditarMonovolumenLista.id);
        scombustible = mon.getCombustible(MenuEditarMonovolumenLista.id);
        snPuertas = mon.getnPuertas(MenuEditarMonovolumenLista.id);
        snRuedas = mon.getnRuedas(MenuEditarMonovolumenLista.id);
        smaxVelocidad = mon.getMaxVelocidad(MenuEditarMonovolumenLista.id);
        scapMotor = mon.getCapMotor(MenuEditarMonovolumenLista.id);
        scapAlmacenamiento = mon.getCapAlmacenamiento(MenuEditarMonovolumenLista.id);
        snPasajeros = mon.getnPasajeros(MenuEditarMonovolumenLista.id);
        sABS = mon.isABS(MenuEditarMonovolumenLista.id);
        sGPS = mon.isGPS(MenuEditarMonovolumenLista.id);
        sairbags = mon.isAirbags(MenuEditarMonovolumenLista.id);
        sclimatizacion = mon.isClimatizacion(MenuEditarMonovolumenLista.id);
        sdescapotable = mon.isDescapotable(MenuEditarMonovolumenLista.id);
        sduenho = mon.getIdcliente(MenuEditarMonovolumenLista.id);
        smotivoVisita = mon.getMotivoVisita(MenuEditarMonovolumenLista.id);
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("EDITAR MONOVOLUMEN");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
	        ...
	        if (mon.editar(MenuEditarMonovolumenLista.id, inputmarca.getText(), inputmodelo.getText(), inputmatricula.getText(), combus, inputnPuertas.getText(), inputnRuedas.getText(), inputmaxVelocidad.getText(), inputcapMotor.getText(), inputcapAlmacenamiento.getText(), inputnPasajeros.getText(), a, g, airb, clim, des, idcli, inputmotivoVisita.getText())) {
				MenuListadoMonovolumenes men = new MenuListadoMonovolumenes();
				dispose();
				men.setVisible(true);
				...
				MenuErrorRegistroMonovolumen men = new MenuErrorRegistroMonovolumen();
				men.setVisible(true);
				dispose();
