...
public class MenuListadoMonovolumenesEscribirMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMonovolumenesEscribirMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MARCA DE MONOVOLÚMENES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoMonovolumenesPorMarca men = new MenuListadoMonovolumenesPorMarca();
			dispose();
			men.setVisible(true);
