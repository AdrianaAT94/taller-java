...
public class MenuListadoMonovolumenesEscribirModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMonovolumenesEscribirModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("BUSCADOR POR MODELO DE MONOVOLÚMENES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("ENVIAR")) {
			MenuListadoMonovolumenesPorModelo men = new MenuListadoMonovolumenesPorModelo();
			dispose();
			men.setVisible(true);
