...
public class MenuMonovolumenInsertado extends JFrame implements KeyListener, ActionListener{
	...
	public MenuMonovolumenInsertado() {
		super("Taller"); //Nome
        ...
        String texto =  "<html><body><p align='center'>MONOVOLUMEN REGISTRADO CORRECTAMENTE</p><br>"
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("VOLVER")) {
			MenuFichaMonovolumen men = new MenuFichaMonovolumen();
			dispose();
			men.setVisible(true);
