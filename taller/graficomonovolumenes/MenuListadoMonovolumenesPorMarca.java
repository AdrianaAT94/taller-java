...
public class MenuListadoMonovolumenesPorMarca extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMonovolumenesPorMarca(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(mon.consultarporMarca(MenuListadoMonovolumenesEscribirMarca.input.getText()));
