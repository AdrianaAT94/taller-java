...
public class MenuMonovolumenes extends JFrame implements KeyListener, ActionListener {
	...
	public void actionPerformed(ActionEvent e) {	
		if (e.getActionCommand().equals("NUEVO")) {
			MenuNuevoMonovolumen con = new MenuNuevoMonovolumen();
		...
		if (e.getActionCommand().equals("CONSULTA")) {
			MenuConsultaMonovolumenes con = new MenuConsultaMonovolumenes();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("EDITAR")) {
			MenuEditarMonovolumenLista con = new MenuEditarMonovolumenLista();
			dispose(); //elimina ventana
			con.setVisible(true);
		...
		if (e.getActionCommand().equals("ELIMINAR")) {
			MenuEliminarMonovolumen con = new MenuEliminarMonovolumen();
			dispose(); //elimina ventana
			con.setVisible(true);
