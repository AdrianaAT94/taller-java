...
public class MenuListadoMonovolumenesPorMatricula extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMonovolumenesPorMatricula(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("LISTADO DE MONOVOLÚMENES");
        label.setFont(new Font("Lucida Sans", Font.BOLD, 20));
        label.setForeground(col);	
        
        etiqueta = new JLabel(mon.consultarporMatricula(MenuListadoMonovolumenesEscribirMatricula.input.getText()));
