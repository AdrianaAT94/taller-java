...
public class MenuListadoMonovolumenesPorModelo extends JFrame implements KeyListener, ActionListener {
	...
	public MenuListadoMonovolumenesPorModelo(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        etiqueta = new JLabel(mon.consultarporModelo(MenuListadoMonovolumenesEscribirModelo.input.getText()));
