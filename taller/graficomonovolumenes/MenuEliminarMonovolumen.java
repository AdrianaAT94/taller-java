...
public class MenuEliminarMonovolumen extends JFrame implements KeyListener, ActionListener {
	...
	public MenuEliminarMonovolumen(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("ELIMINAR MONOVOLUMEN");
