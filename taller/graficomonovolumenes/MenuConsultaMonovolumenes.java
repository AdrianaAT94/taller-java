...
public class MenuConsultaMonovolumenes extends JFrame implements KeyListener, ActionListener {
	...
	public MenuConsultaMonovolumenes(){
		super("Taller"); //Nome
      ...
      //Creanse paneles e daselle un color de fondo
        ...
        label = new JLabel("GESTIÓN DE MONOVOLÚMENES");
	...
	public void actionPerformed(ActionEvent e) {	
		...
		if (e.getActionCommand().equals("POR MATRÍCULA")) {
			MenuListadoMonovolumenesEscribirMatricula men = new MenuListadoMonovolumenesEscribirMatricula();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MARCA")) {
			MenuListadoMonovolumenesEscribirMarca men = new MenuListadoMonovolumenesEscribirMarca();
			dispose(); //elimina ventana
			men.setVisible(true);
		...
		if (e.getActionCommand().equals("POR MODELO")) {
			MenuListadoMonovolumenesEscribirModelo men = new MenuListadoMonovolumenesEscribirModelo();
			dispose(); //elimina ventana
			men.setVisible(true);
